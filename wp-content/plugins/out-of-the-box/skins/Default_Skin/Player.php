...
class Default_Skin extends MediaplayerSkin
{
    ...
    public function load_scripts($dependency = [])
    {
        ...
        wp_register_script('Default_Skin.Library', $this->get_url().'/js/mediaelement-and-player.min.js', $dependency, OUTOFTHEBOX_VERSION);
        wp_register_script('OutoftheBox.Default_Skin.Player', $this->get_url().'/js/Player.js', ['WPCloudPlugins.Polyfill', 'Default_Skin.Library', 'WPCloudplugin.Libraries'], OUTOFTHEBOX_VERSION, true);
