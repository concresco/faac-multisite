(function ($) {
    ...
    $('#nf-builder').on('click', '.outofthebox.open-shortcode-builder', function () {
        var input_field = $('#wpcp_outofthebox_shortcode');
    ...
    function openShortcodeBuilder(shortcode) {
        ...
        var $iframe_template = $(
            "<iframe src='" +
                window.ajaxurl +
                '?action=outofthebox-getpopup&type=modules&foruploadfield=1&callback=uses_listener&' +
                query +
