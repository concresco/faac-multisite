...
<div id="wpcp" class="wpcp-app">
    ...
    <!-- Modal Selector -->
    <div id="wpcp-modal-acf-selector-dropbox" class="wpcp-dialog hidden">
                        ...
                        <div>
                            ...
                            <div class="mt-3 text-center sm:mt-5">
                                ...
                                <div class="mt-6 mb-4 sm:flex items-center justify-center">
                                    <div id='oftb-embedded' class="w-full">
                                        <?php
...
$params = apply_filters('outofthebox_set_shortcode_file_selector', $params, 'advancedcustomfields');
