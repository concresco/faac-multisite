...
class Thumbnail
{
    ...
    public function build_thumbnail()
    {
        ...
        try {
            ...
            Helpers::log_error('Cannot generate thumbnail.', 'Thumbnail', ['entry_id' => $this->_get_entry()->get_id(), 'entry_path' => $this->_get_entry()->get_path()], __LINE__, $ex);
    ...
    {
        return OUTOFTHEBOX_ADMIN_URL.'?action=outofthebox-thumbnail&src='.$this->_thumbnail_name.'&account_id='.App::get_current_account()->get_uuid();
    }
    ...
    private function _create_thumbnail()
    {
        ...
        try {
            ...
            Helpers::log_error('Cannot create thumbnail.', 'Thumbnail', null, __LINE__, $ex);
    ...
    private function _crop_thumbnail()
    {
        try {
            ...
            if ('png' === $this->_get_entry()->get_extension()) {
    ...
    private function _load_phpthumb_object()
    {
        if (!class_exists('\TheLion\OutoftheBox\phpthumb')) {
            try {
                ...
                Helpers::log_error('Cannot load PHPTHUMB library.', 'Thumbnail', null, __LINE__, $ex);
            }
        }
