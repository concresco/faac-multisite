...
class Helpers
{
    ...
    public static function get_page_url($clean_url = false)
    {
        ...
        return esc_url($url, null, 'db');
    }

    public static function select_callback($callback)
    {
        switch ($callback) {
            case 'wpcp_oftb_cf7_add_content':
            case 'wpcp_oftb_elementor_add_content':
            case 'wpcp_oftb_gf_add_content':
            case 'wpcp_oftb_wc_add_content':
    ...
    {
        Helpers::is_deprecated('function', 'apply_placeholders()', '\TheLion\OutoftheBox\Placeholders::apply()');
    ...
    {
        if (!defined('OUTOFTHEBOX_ICON_SET')) {
            define('OUTOFTHEBOX_ICON_SET', Settings::get('icon_set'));
        }

        return OUTOFTHEBOX_ICON_SET;
    }
    ...
    public static function get_default_icon($mimetype, $is_dir = false)
    {
        ...
        return Helpers::get_iconset_url().'32x32/'.$icon.'.png';
    }
    ...
    public static function get_mimetype($extension = '')
    {
        ...
        $mime_types_map = apply_filters('outofthebox_set_mimetypes', $mime_types_map);
