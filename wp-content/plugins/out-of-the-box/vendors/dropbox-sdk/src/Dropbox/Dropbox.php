...
use TheLion\OutoftheBox\Vendors\GuzzleHttp\Psr7\Stream;
...
class Dropbox
{
     ...
     * @const int
     */
    public const DEFAULT_CHUNK_SIZE = 50000000;
     ...
     *
     * @return string|\TheLion\OutoftheBox\API\Dropbox\Models\AccessToken Access Token
     */
    ...
    public function sendRequest($method, $endpoint, $endpointType = 'api', array $params = [], $accessToken = null)
    {
        ...
        if ($this->getOAuth2Client()->isAccessTokenExpired()) {
            ...
            do_action('out-of-the-box-refresh-token', \TheLion\OutoftheBox\App::get_current_account());
    ...
    public function getTemporarilyUploadLink($path, array $commit_info = [], $origin = '', $duration = 14400)
    {
        ...
        // Make a DropboxRequest object
        $request = new DropboxRequest('POST', '/files/get_temporary_upload_link', $accessToken, ' api', $params);
