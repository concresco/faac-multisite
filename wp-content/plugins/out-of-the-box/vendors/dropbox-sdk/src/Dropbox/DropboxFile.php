...
class DropboxFile
{
     ...
     * File Stream.
     *
     * @var \TheLion\OutoftheBox\Vendors\GuzzleHttp\Psr7\Stream
     */
    protected $stream;
    ...
    public function open()
    {
        ...
        $this->stream = \TheLion\OutoftheBox\Vendors\GuzzleHttp\Psr7\Utils::streamFor(fopen($this->path, 'r'));
     ...
     *
     * @return \TheLion\OutoftheBox\Vendors\GuzzleHttp\Psr7\Stream
     */
    ...
    {
        return \TheLion\OutoftheBox\Vendors\GuzzleHttp\Psr7\MimeType::fromFilename($this->path) ?: 'text/plain';
    }
