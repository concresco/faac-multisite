...
use \TheLion\OutoftheBox\Vendors\GuzzleHttp\Client as Guzzle;
...
class DropboxHttpClientFactory
{
    ...
    public static function make($handler)
    {
        ...
        //Invalid handler
        throw new InvalidArgumentException('The http client handler must be an instance of \TheLion\OutoftheBox\Vendors\GuzzleHttp\Client or an instance of TheLion\OutoftheBox\API\Dropbox\Http\Clients\DropboxHttpClientInterface.');
    }
}
