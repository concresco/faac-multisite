                                                            ...
                                                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                                <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#000000;">
                                                                    <p>The
                                                                        ...
                                                                        </a> is not able to refresh access to the Dropbox <strong><?php echo !empty($account) ? '('.$account->get_email().'- ID: '.$account->get_id().')' : ''; ?></strong>. It is possible that you will need to re-connect the plugin to your account by going to the Admin Dashboard.
                                                                    </p>
                                                                    </p>
