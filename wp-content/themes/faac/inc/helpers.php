...
function in_array_product( $needle, $return, $haystack ) {
  // Check if haystack is null or not an array
  if ( is_null($haystack) || ! is_array( $haystack ) ) return false;
...
function in_array_multi( $needle, $return, $haystack ) {
  // Check if haystack is null or not an array
  if ( is_null($haystack) || ! is_array( $haystack ) ) return false;
...
function get_url_category($gfg_array, $search, $return) {
  ...
  if (empty($gfg_array) || !is_array($gfg_array)) {
    return '';
  }
