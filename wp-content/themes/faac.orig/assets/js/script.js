	...
	function AddReadMore() {
		...
		$(".add-read-more").each(function () {
			...
			if (allstr.length > carLmt) {
				...
				var strtoadd = firstSet + point + "<span class='second-section'>" + secdHalf + "</span><br><span class='read-more-btn icon-down'  title='Click to Show More'>" + readMoreTxt + "</span><span class='read-less-btn icon-top' title='Click to Show Less'>" + readLessTxt + "</span>";
				$(this).html(strtoadd);
			}
		});
